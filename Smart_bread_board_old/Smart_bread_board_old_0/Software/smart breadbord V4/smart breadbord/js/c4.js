...
//code editted by vikrant 1

TransformerSymbol = function(x,y,rotation,value){
   this.points=[[0,4.5],[0,6],null,[0,-4.5],[0,-6],null,[-2,4],[-1,3],null,[-1,3],[1,3],null,[-2,2],[2,2],null,[-2,-2],[2,-2],null,[2,-4],[1,-3],null,[1,-3],[-1,-3],null,[-2,-4],[-1,-3],null,[1,3],[2,4],null];
    this.circles=[[0,0,4.5,2*Math.PI]]
    Component.call(this,x,y,rotation)
    this.value = value
}
TransformerSymbol.prototype = new Component()
TransformerSymbol.prototype.buildNet=function(recordNet,unionNet)
{
    var n1=recordNet(this.objectToWorld(0,-6));
    var n2=recordNet(this.objectToWorld(0,6));
    return ["T",[n1,n2]]
...
SchematicCapture.prototype.addComponent = function(componentType,x,y){
    ...
    switch(componentType){
		...
		case "tSource": newGuy=new TransformerSymbol(xWorld,yWorld,0,"square,.3,0,5");break;
